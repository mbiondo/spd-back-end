...
class CitacionGpaInvitaEntidad(models.Model):
    ...
    citacion_gpa = models.ForeignKey('CitacionGpa', db_column='fk_citacion_gpa', blank=True, null=True, related_name='invitados_gpa')
    entidad = models.ForeignKey('Entidad', db_column='fk_entidad', blank=True, null=True)
