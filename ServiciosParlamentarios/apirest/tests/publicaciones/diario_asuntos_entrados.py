...
class TestDiarioAsuntosEntrados(APITestCase):
    ...
    def test_bn_list(self):
        """
        Prueba el servicio para listar los DAE. 
        """
        response = self.client.get('/apirest/diario_asuntos_entrados/')
    ...
    def test_bn_por_numero(self):
        ...
        """
        response = self.client.get("/apirest/diario_asuntos_entrados/?numero=1")
        self.assertEqual(response.status_code, self.CODIGO_EXITO)
    ...
    def test_bn_por_id(self):
        ...
        """
        response = self.client.get("/apirest/diario_asuntos_entrados/45908/")
        self.assertEqual(response.status_code, self.CODIGO_EXITO)
