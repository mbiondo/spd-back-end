...
class Constants():
    ...
    BOLETIN_ASUNTOS_ENTRADOS = 'boletin_asuntos_entrados'
    BOLETIN_ASUNTOS_TRATADOS = 'boletin_asuntos_tratados'
    BOLETIN_NOVEDADES = 'boletin_novedades'
    ...
    DIARIO_ASUNTOS_ENTRADOS = 'diario_asuntos_entrados'
    DICTAMEN = 'dictamen'
    ...
    GIRO = 'giro'
    GIROS = 'giros'
    GPA_ESTRUCTURA = 'gpa_estructura'
    GPA_HIST = 'gpa_hist'
    GRUPO_PARLAMENTARIO_AMISTAD = 'grupo_parlamentario_amistad'
    ...
    TRAMITE_PARLAMENTARIO = 'tramite_parlamentario'
    VETO = 'veto'
