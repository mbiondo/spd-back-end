...
DATABASES = {
    'default': {
        ...
        'NAME': 'servicios_parlamentarios',     #name of the django database
        'USER': 'servicios',    #user of the django database
        'PASSWORD': 'honorablepass',    #password of the django database
        'HOST': 'localhost',
        'PORT': '5432',
    },
    'pap_nueva_pruebas': {
