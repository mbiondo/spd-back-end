...
if [ -d "$SP_PATH" ]; then
        python manage.py runsslserver --certificate /usr/share/ca-certificates/hcdn/hcdn.gob.ar.crt --key /usr/share/ca-certificates/hcdn/hcdn.gob.ar.key --addrport api.hcdn.gob.ar:8000
